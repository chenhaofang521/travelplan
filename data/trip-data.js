...
window.TRIP_DATA = {
  ...
  phrases: [
    ...
    { zh: "请再说一遍", ko: "다시 말해 주세요", pronunciation: "Da-si mal-hae ju-se-yo" },
    { zh: "有会说中文的人吗？", ko: "중국어 할 수 있는 분 있어요?", pronunciation: "Jung-gu-geo hal su it-neun bun it-seo-yo?" },
    { zh: "办理入住", ko: "체크인해 주세요", pronunciation: "Che-keu-in-hae ju-se-yo" },
    { zh: "退房", ko: "체크아웃해 주세요", pronunciation: "Che-keu-a-ut-hae ju-se-yo" },
    { zh: "Wi-Fi 密码是多少？", ko: "와이파이 비밀번호가 뭐예요?", pronunciation: "Wai-pai bi-mil-beon-ho-ga mwo-ye-yo?" },
    { zh: "地铁站在哪里？", ko: "지하철역이 어디예요?", pronunciation: "Ji-ha-cheol-yeok-i eo-di-ye-yo?" },
    { zh: "去地铁站怎么走？", ko: "지하철역 어떻게 가요?", pronunciation: "Ji-ha-cheol-yeok eo-tteo-ke ga-yo?" },
    { zh: "请问怎么去这里？", ko: "여기 어떻게 가요?", pronunciation: "Yeo-gi eo-tteo-ke ga-yo?" },
    { zh: "请去这里（给司机看）", ko: "여기로 가 주세요", pronunciation: "Yeo-gi-ro ga ju-se-yo" },
    { zh: "一直走", ko: "쭉 가세요", pronunciation: "Jjuk ga-se-yo" },
    { zh: "左转", ko: "왼쪽으로 가세요", pronunciation: "Oen-jjok-eu-ro ga-se-yo" },
    { zh: "右转", ko: "오른쪽으로 가세요", pronunciation: "O-reun-jjok-eu-ro ga-se-yo" },
    { zh: "洗手间在哪里？", ko: "화장실이 어디예요?", pronunciation: "Hwa-jang-sil-i eo-di-ye-yo?" },
    { zh: "烤肉（牛肉）", ko: "불고기", pronunciation: "Bul-go-gi" },
    { zh: "韩牛", ko: "한우", pronunciation: "Han-u" },
    { zh: "牛排骨", ko: "갈비", pronunciation: "Gal-bi" },
    { zh: "酱蟹", ko: "간장게장", pronunciation: "Gan-jang-ge-jang" },
    { zh: "海鲜", ko: "해산물", pronunciation: "Hae-san-mul" },
    { zh: "海鲜锅", ko: "해물탕", pronunciation: "Hae-mul-tang" },
    { zh: "参鸡汤", ko: "삼계탕", pronunciation: "Sam-gye-tang" },
    { zh: "石锅拌饭", ko: "비빔밥", pronunciation: "Bi-bim-bap" },
    { zh: "冷面", ko: "냉면", pronunciation: "Naeng-myeon" },
    { zh: "泡菜", ko: "김치", pronunciation: "Gim-chi" }
  ],
